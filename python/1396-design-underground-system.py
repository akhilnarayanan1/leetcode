...
class UndergroundSystem:
    ...
    def checkOut(self, id: int, stationName: str, t: int) -> None:
        ...
        self.journey_data.append((start_station, end_station, end_time-start_time))
        

    def getAverageTime(self, startStation: str, endStation: str) -> float:
        time = 0
        total = 0
        for journey in self.journey_data:
            if journey[0]==startStation and journey[1]==endStation:
                time += journey[2]   
                total += 1
        return (time/total)
...
# 🔥with collection defaultdict (faster)
class UndergroundSystem:
